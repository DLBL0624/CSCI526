...
public class HexFeatureManager : MonoBehaviour
{
    ...
    void AddWallSegment( Vector3 nearLeft, Vector3 farLeft, Vector3 nearRight, Vector3 farRight, bool addTower = false)
    {
        ...
        Vector3 leftThicknessOffset = HexMetrics.WallThinknessOffset(nearLeft, farLeft);
        Vector3 rightThicknessOffset = HexMetrics.WallThinknessOffset(nearRight, farRight);
    ...
    void AddWallCap (Vector3 near, Vector3 far)
    {
        ...
        Vector3 thickness = HexMetrics.WallThinknessOffset(near, far);
