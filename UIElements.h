...
namespace CSCI526-master {
    ...
    inline NewDataSet::NewDataSet() {
        this->BeginInit();
        this->InitClass();
        ::System::ComponentModel::CollectionChangeEventHandler^  schemaChangedHandler = gcnew ::System::ComponentModel::CollectionChangeEventHandler(this, &CSCI526-master::NewDataSet::SchemaChanged);
    ...
    inline NewDataSet::NewDataSet(::System::Runtime::Serialization::SerializationInfo^  info, ::System::Runtime::Serialization::StreamingContext context) : 
        ...
        if (this->IsBinarySerialized(info, context) == true) {
            this->InitVars(false);
            ::System::ComponentModel::CollectionChangeEventHandler^  schemaChangedHandler1 = gcnew ::System::ComponentModel::CollectionChangeEventHandler(this, &CSCI526-master::NewDataSet::SchemaChanged);
    ...
    inline ::System::Data::DataSet^  NewDataSet::Clone() {
        CSCI526-master::NewDataSet^  cln = (cli::safe_cast<CSCI526-master::NewDataSet^  >(__super::Clone()));
        cln->InitVars();
    ...
    inline ::System::Xml::Schema::XmlSchemaComplexType^  NewDataSet::GetTypedDataSetSchema(::System::Xml::Schema::XmlSchemaSet^  xs) {
        CSCI526-master::NewDataSet^  ds = (gcnew CSCI526-master::NewDataSet());
