...
public static class HexMetrics
{
    ...
    public const float elevationStep = 3f;  //高度阶差

    public const int terracesPerSlope = 2;  //缓坡个数

    public const int terraceSteps = terracesPerSlope * 2 + 1;   //缓坡阶梯数
    ...
    public static Vector3 WallThinknessOffset(Vector3 near, Vector3 far)
    {
        Vector3 offset;
