...
float4 GetCellData(appdata_full v, int index)
{
	...
	data.w *= 255;	//GPU will automatically convert the data into a floating-point value in the range of 0-1, to convert it back to its proper value, multiply it with 255.
	return data;
}
